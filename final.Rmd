...
summary(without_math)
summary(without_reading)
summary(without_writing)
```
...
cv_df_math |>
  ...
  labs(
    title = "Prediction Errors For Math Model Under CV",
    x = "MLR",
    y = "Prediction Errors"
  ) +
  theme_minimal() +
...
cv_df_reading |>
  ...
  labs(
    title = "Prediction Errors For Reading Model Under CV",
    x = "MLR",
    y = "Prediction Errors"
  ) +
  theme_minimal() +
...
cv_df_writing |>
  ...
  labs(
    title = "Prediction Errors For Writing Model Under CV",
    x = "MLR",
    y = "Prediction Errors"
  ) +
  theme_minimal() +
